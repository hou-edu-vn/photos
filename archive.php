    ...
    <div class="">
        <div class="<?php mts_article_class(); ?>">
            <div id="content_box">
                <h1 class="postsby">
                    <?php if (is_category()) { ?>
                        <span><?php single_cat_title(); ?><?php _e(" ", "mythemeshop"); ?></span>
                    <?php } elseif (is_tag()) { ?> 
                        <span><?php single_tag_title(); ?><?php _e(" ", "mythemeshop"); ?></span>
                    <?php } elseif (is_author()) { ?>
                        <span><?php
                            ...
                            ?></span>
                    <?php } elseif (is_day()) { ?>
                        <span><?php _e("Ngày :", "mythemeshop"); ?></span> <?php the_time('l, F j, Y'); ?>
                    <?php } elseif (is_month()) { ?>
                        <span><?php _e("Tháng :", "mythemeshop"); ?></span> <?php the_time('F Y'); ?>
                    <?php } elseif (is_year()) { ?>
                        <span><?php _e("Năm :", "mythemeshop"); ?></span> <?php the_time('Y'); ?>
                    <?php } ?>
                </h1>
                <?php
                $j = 0;
